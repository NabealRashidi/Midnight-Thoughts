# Midnight Thoughts That Keep Me Awake
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/q8o97mxy/settings/api) and create a token with read rights.
